...
<!-- Generated by grimoire — do not edit manually -->

You are working with an experienced developer.
Be direct. Skip obvious explanations unless asked.
When something is ambiguous, ask before assuming.

## This project

Go 1.22+ service. Stdlib where possible.
No ORM — use sqlx or pgx directly. Follow effective Go conventions.

**Stack:** go, docker

## How to work with me

- Always consider security implications before suggesting code
- Prefer readable, maintainable code over clever code
- When making architectural decisions, explain the tradeoffs
- Do not remove existing functionality unless explicitly asked
- Handle all errors explicitly — no naked underscore ignores
...
MANDATORY: Every time you write, modify, or explain code in this session,
append an entry to KNOWLEDGE.md using exactly this structure:
